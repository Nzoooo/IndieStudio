...
ecs::Core initConnectPlayers()
{
    ...
    player->add<ComponentModel>("assets/Among_Us_.obj", raylib::Vector3(-5.0f, -1.0f, 0.5f), raylib::Vector3(0.7f, 0.7f, 0.7f));
    player->add<ComponentTexture>("assets/AmongUsTrsp.png", raylib::Vector2(160.0f, 330.0f), raylib::Vector2(255.0f, 820.0f));
    player->add<ComponentControllable>();
    ecs::IEntity *player2 = new ecs::IEntity();
    player2->add<ComponentDrawable>(true, false);
    player2->add<ComponentModel>("assets/Among_Us_.obj", raylib::Vector3(-1.7f, -1.0f, 0.5f), raylib::Vector3(0.7f, 0.7f, 0.7f));
    player2->add<ComponentTexture>("assets/AmongUsTrsp.png", raylib::Vector2(580.0f, 330.0f), raylib::Vector2(675.0f, 820.0f));
    player2->add<ComponentControllable>();
    ecs::IEntity *player3 = new ecs::IEntity();
    player3->add<ComponentDrawable>(true, false);
    player3->add<ComponentModel>("assets/Among_Us_.obj", raylib::Vector3(1.55f, -1.0f, 0.5f), raylib::Vector3(0.7f, 0.7f, 0.7f));
    player3->add<ComponentTexture>("assets/AmongUsTrsp.png", raylib::Vector2(1000.0f, 330.0f), raylib::Vector2(1095.0f, 820.0f));
    player3->add<ComponentControllable>();
    ecs::IEntity *player4 = new ecs::IEntity();
    player4->add<ComponentDrawable>(true, false);
    player4->add<ComponentModel>("assets/Among_Us_.obj", raylib::Vector3(4.8f, -1.0f, 0.5f), raylib::Vector3(0.7f, 0.7f, 0.7f));
    player4->add<ComponentTexture>("assets/AmongUsTrsp.png", raylib::Vector2(1420.0f, 330.0f), raylib::Vector2(1515.0f, 820.0f));
    player4->add<ComponentControllable>();
    ecs::IEntity *scanner = new ecs::IEntity();
    scanner->add<ComponentDrawable>(true, false);
    scanner->add<ComponentTexture>("assets/scanner.png", raylib::Vector2(120.0f, 580.0f));
    ecs::IEntity *scanner2 = new ecs::IEntity();
    scanner2->add<ComponentDrawable>(true, false);
    scanner2->add<ComponentTexture>("assets/scanner.png", raylib::Vector2(540.0f, 580.0f));
    ecs::IEntity *scanner3 = new ecs::IEntity();
    scanner3->add<ComponentDrawable>(true, false);
    scanner3->add<ComponentTexture>("assets/scanner.png", raylib::Vector2(960.0f, 580.0f));
    ecs::IEntity *scanner4 = new ecs::IEntity();
    scanner4->add<ComponentDrawable>(true, false);
    scanner4->add<ComponentTexture>("assets/scanner.png", raylib::Vector2(1380.0f, 580.0f));
    ecs::IEntity *background = new ecs::IEntity();
    background->add<ComponentDrawable>(true, false);
    background->add<ComponentTexture>("assets/bgConnectPlayers.png", raylib::Vector2(0.0f, 0.0f));
    ...
    std::string trspTexturePath = "assets/trspTexture.png";
