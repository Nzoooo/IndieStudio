...
static ecs::Core initSettings()
{
    ...
    nbBot->add<ComponentText>("assets/NewAthletic.ttf", "0", raylib::Vector2(1920 / 2.0f - (stringLen("0") * 25), 320.0), 70, raylib::Color::White());
    ...
    nbBomb->add<ComponentText>("assets/NewAthletic.ttf", "3", raylib::Vector2(1920 / 2.0f - (stringLen("3") * 25), 470.0), 70, raylib::Color::White());
    ...
    boolBonus->add<ComponentText>("assets/NewAthletic.ttf", "yes", raylib::Vector2(1920 / 2.0f - (stringLen("yes") * 15), 620.0), 70, raylib::Color::White());
